...
export class TypeOfTypeItemView {
  adminView = new AdminView();
  typeOfTypeListView = new TypeOfTypeListView();
  validationService = new ValidationService();
  helper = new e2eHelper();
  metaData = require('./type-of-type.metaData.json');
  ...
  createNewItem(item: any): void {
    this.typeOfTypeListView.addButton.click();
