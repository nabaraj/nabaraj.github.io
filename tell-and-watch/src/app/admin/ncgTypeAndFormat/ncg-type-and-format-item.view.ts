...
export class NcgTypeAndFormatItemView {
  adminView = new AdminView();
  ncgTypeAndFormatListView = new NcgTypeAndFormatListView();
  validationService = new ValidationService();
  helper = new e2eHelper();
  metaData = require('./ncg-type-and-format.metaData.json');
  ...
  createNewItem(item: any): void {
    this.ncgTypeAndFormatListView.addButton.click();
