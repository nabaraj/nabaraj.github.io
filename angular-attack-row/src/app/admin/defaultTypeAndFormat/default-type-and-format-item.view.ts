...
export class DefaultTypeAndFormatItemView {
  adminView = new AdminView();
  defaultTypeAndFormatListView = new DefaultTypeAndFormatListView();
  validationService = new ValidationService();
  helper = new e2eHelper();
  metaData = require('./default-type-and-format.metaData.json');
  ...
  createNewItem(item: any): void {
    this.defaultTypeAndFormatListView.addButton.click();
