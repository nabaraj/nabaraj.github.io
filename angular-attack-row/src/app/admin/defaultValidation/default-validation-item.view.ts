...
export class DefaultValidationItemView {
  adminView = new AdminView();
  defaultValidationListView = new DefaultValidationListView();
  validationService = new ValidationService();
  helper = new e2eHelper();
  metaData = require('./default-validation.metaData.json');
  ...
  createNewItem(item: any): void {
    this.defaultValidationListView.addButton.click();
