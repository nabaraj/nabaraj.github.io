...
export class ValidationItemView {
  adminView = new AdminView();
  validationListView = new ValidationListView();
  validationService = new ValidationService();
  helper = new e2eHelper();
  metaData = require('./validation.metaData.json');
  ...
  createNewItem(item: any): void {
    this.validationListView.addButton.click();
