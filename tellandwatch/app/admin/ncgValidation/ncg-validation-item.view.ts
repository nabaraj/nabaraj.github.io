...
export class NcgValidationItemView {
  adminView = new AdminView();
  ncgValidationListView = new NcgValidationListView();
  validationService = new ValidationService();
  helper = new e2eHelper();
  metaData = require('./ncg-validation.metaData.json');
  ...
  createNewItem(item: any): void {
    this.ncgValidationListView.addButton.click();
